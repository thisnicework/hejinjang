...
const routes = {
  ...
  '/about-bio': {
    ...
    render: () => `
      <div class="content-page">
        ...
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-size:15px;" class="wixui-rich-text__text">​</span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-size:15px;" class="wixui-rich-text__text"><span style="font-weight:bold;" class="wixui-rich-text__text"><span style="color:#FF00CB;" class="wixui-rich-text__text">Current Research</span></span></span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-size:15px;" class="wixui-rich-text__text">Jang is currently pursuing a practice-based PhD in Creativity at Transart Institute, in partnership with Liverpool John Moores University. Her research investigates choreography as a ritualistic methodology of resilience and embodied historiography. She reimagines rehearsal as a speculative, socio-political, and sensory site — one that traverses inherited trauma, collective repair, and invisible embodiment. Through somatic whispering, proprioceptive exploration, and artistic autoethnography, she constructs listening environments that operate with and through the body. She is also a certified Franklin Method® educator, a somatic practice grounded in Dynamic Neurocognitive Imagery™, which informs her movement education and embodied research.</span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-size:15px;" class="wixui-rich-text__text"><span class="color_38 wixui-rich-text__text"><span style="text-decoration:underline;" class="wixui-rich-text__text">E<span style="font-weight:bold;" class="wixui-rich-text__text">nglish CV</span></span></span></span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-size:15px;" class="wixui-rich-text__text">​​​</span></p>
        
                    <div class="about-image-container" style="margin-bottom: 24px;">
                      <img src="/images/073f40_2297e8f0e68e48f89b1818f21e2028ee_mv2.jpeg" style="width: 100%; max-width: 100%; height: auto; display: block;" alt="Image" loading="lazy">
                    </div>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-size:15px;" class="wixui-rich-text__text"><span class="wixui-rich-text__text">​</span>​</span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-size:15px;" class="wixui-rich-text__text"><span class="wixui-rich-text__text">​</span></span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-size:15px;" class="wixui-rich-text__text"><span style="font-weight:bold;" class="wixui-rich-text__text"><span style="color:#FF00CB;" class="wixui-rich-text__text">혜진장댄스</span></span></span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-size:15px;" class="wixui-rich-text__text">He Jin Jang Dance는 생로병사를 겪는 연약한 몸, 그리고 그 몸이 사회적 구조와 관계 맺는 방식을 감각하고 질문하는 프로젝트 그룹이다. 춤 창작과 리서치, 퍼포먼스, 집필, 담론, 워크숍을 오가며, 프로젝트마다 유동적으로 구성되는 협업자들과 함께 작업을 확장해 왔다. 고정된 앙상블이 아니라, 친밀성과 비판적 협업, 신체 기반 지식 생산이 교차하는 다공성 구조(porous constellation)로 작동한다. 관심의 중심에는 늘 보이지 않는 것들이 있다 — 보이지 않는 몸, 말해지지 않은 슬픔, 사소한 몸짓, 비선형적인 공동체적 의례. 동양의 심신 철학을 기반으로, 탄생과 노화, 질병과 죽음이라는 생의 네 단계를 가로지르며 몸의 취약함을 예술 언어로 탐색해왔다. 2008년 미국에서 발표한 첫 작업 <span style="font-style:italic;" class="wixui-rich-text__text">open skin inscribed</span>는 유전성 피부병에 관한 가족사를 리서치하여, 몸과 사회를 구성하는 감각의 표면으로서 피부에 주목한 안무였다. 이 작업은 『인디 위크』로부터 “우리 모두를 겸허하게 만드는 작품”이라는 평을 받았다. 이후 서울국제무용제, MODAFE, 플랫폼-엘 PLAP, Laboratorio Condensación(멕시코), 부쿠레슈티 국립현대미술관(루마니아), Temps d'Image Festival (루마니아), Musikfestival Bern(스위스), 뉴욕 라이브 아츠, 더 키친 등 30여 개 도시의 예술기관과 페스티벌에서 작업을 발표하며, 퍼포먼스, 전시, 워크숍, 렉처, 대화 등 다양한 형태로 리서치를 공유해 왔다. 한국문화예술위원회, 서울문화재단, 예술경영지원센터 등의 지원 아래 진행된 작업들은, 소매틱 즉흥, 심상, 언어, 사회적 비평을 연결하며 집단 자각몽의 순간을 불러낸다. 이러한 예술적 사건들은 고통과 유머, 과거와 미래, 외부와 내부, 개인과 공동의 기억을 넘나들며, 공동 생존의 감각을 리허설하는 공간을 구성한다.</span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-size:15px;" class="wixui-rich-text__text">​</span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-size:15px;" class="wixui-rich-text__text"><span style="font-weight:bold;" class="wixui-rich-text__text"><span style="color:#FF00CB;" class="wixui-rich-text__text">장혜진&nbsp;</span></span></span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-size:15px;" class="wixui-rich-text__text">장혜진은 서울에서 태어나 다양한 도시를 기반으로 활동해온 안무가이자 리서처다. 인간이 피할 수 없는 연약함에 대해 몸이 반응하는 방식을 감각하고, 그 신경계의 움직임을 안무로 조직하며, 생존의 리듬을 라이브 아트의 언어로 탐구해왔다. 『월간 몸』은 그녀를 “대담무쌍하고 솔직한 안무가”로 소개한 바 있다. 그녀의 작업은 소매틱 움직임, 페미니즘 이론, 토착 치유 지식을 기반으로 하며, 안무 창작과 연구, 퍼포먼스 코칭, 예술 기획과 드라마투르기를 넘나들며 펼쳐진다. 그간 오스트리아 DanceWeb 펠로우십(2011), 뉴욕 Movement Research 상주예술가(2009–11), 루마니아 무빙 다이얼로그 교환안무가(2011), 뉴욕 라이브 아츠 Fresh Tracks 상주예술가(2014–15), Knowing Dance More 초청 안무가(2017), 멕시코 Laboratorio Condensación 초청 안무가(2018), 일본 Saison Foundation 온라인 상주예술가(2021–22), 캐나다 지브랄타 포인트 상주예술가(2024) 등에 선정되며, 국제적 네트워크 안에서 다층적인 리서치를 이어왔다. 동료 예술가들의 작업을 돌보는 퍼포먼스 코치, 예술 자문, 드라마투르그로서의 활동도 꾸준히 지속해왔으며, 뉴욕예술재단 안무 멘토(2014), 서울무용센터 자문위원(2016–19), 아시아문화전당 안무랩 멘토(2019–21), 미국 유아츠 대학원 안무 멘토(2019–21), 국립현대무용단 퍼포먼스 코치(2022–23)로도 참여해왔다. 어술리 이글리, 제임스 커즌즈, 안애순, 이은경, 허윤경 등의 작업에 드라마투르그로 함께했다. 또한 국립현대무용단 Choreo-Lab(2016), 서울문화재단 서울국제안무워크숍(2017), 아르코예술극장 Brick-Break Platform(2021) 등을 공동 기획하며, 안무와 공동체적 실천이 만나는 새로운 예술적 구조를 구상하고 실현해왔다. 서울대학교 체육교육과 무용전공을 졸업하고, 미시간대학교에서 무용 석사과정을 수료했으며, 미국 홀린즈대학교에서 안무 석사를 마쳤다. 현재는 싱가포르에 거주하며, T:Works의 Artistic Director Academy 펠로우로 활동 중, 탠저린 콜렉티브의 공동 멤버이기도 하다.</span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-size:15px;" class="wixui-rich-text__text"><span style="font-weight:bold;" class="wixui-rich-text__text"><span style="color:#FF00CB;" class="wixui-rich-text__text">최근 연구</span></span></span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-size:15px;" class="wixui-rich-text__text"><span style="color:#000000;" class="wixui-rich-text__text">장혜진은 현재 Transart Institute와 Liverpool John Moores University의 공동 프로그램으로 실천 기반 박사과정(Practice-Based PhD)에 재학 중이다. 그녀의 연구는 안무를 회복력과 몸의 역사 쓰기를 위한 의례적 방법론으로 바라보며, 리허설을 상상적이고, 사회정치적이며, 감각적인 실천의 장소로 새롭게 정의한다.&nbsp;</span><span style="color:#000000;" class="wixui-rich-text__text">그녀는 유전된 트라우마, 공동 회복, 비가시적 몸의 현존을 다루며, 소매틱 속삭임(somatic whispering), 고유수용감각 탐색(proprioceptive guidance), 예술적 자문화기술지(artistic autoethnography)를 활용해 몸으로 듣는 리서치 환경을 구축한다.&nbsp;</span><span style="color:#000000;" class="wixui-rich-text__text">또한, Franklin Method® 공인 교육자로서, Dynamic Neurocognitive Imagery™ 기반의 소매틱 접근법을 자신의 무브먼트 교육 및 연구에 적극적으로 적용하고 있다.</span></span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-size:15px;" class="wixui-rich-text__text"><span style="color:#000000;" class="wixui-rich-text__text">​</span></span></p>
  ...
  '/upcoming': {
    ...
    render: () => `
      <div class="content-page">
        ...
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span class="color_42 wixui-rich-text__text"><span style="text-shadow:#ffffff 0px 0px 6px;" class="wixui-rich-text__text"><span style="font-weight:bold;" class="wixui-rich-text__text">Sep 18–21, 2025:&nbsp; Unseaming. — SIDance Festival, Korea</span></span></span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span class="color_42 wixui-rich-text__text"><span style="text-shadow:#ffffff 0px 0px 6px;" class="wixui-rich-text__text"><span style="font-weight:bold;" class="wixui-rich-text__text"><span class="wixui-rich-text__text">​</span></span></span></span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span class="color_42 wixui-rich-text__text"><span style="text-shadow:#ffffff 0px 0px 6px;" class="wixui-rich-text__text"><span style="font-weight:bold;" class="wixui-rich-text__text">Sep 22 · Artist’s Talk &amp; Workshop at Korea National University of the Arts</span></span></span></p>
        ...
        <span class="color_42 wixui-rich-text__text"><span style="text-shadow:#ffffff 0px 0px 6px;" class="wixui-rich-text__text"><span style="font-weight:bold;" class="wixui-rich-text__text">2025 Oct 13–24 · Guest Choreographer — LASALLE College of the Arts, Singapore</span></span></span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><br class="wixui-rich-text__text">
        <span class="color_42 wixui-rich-text__text"><span style="text-shadow:#ffffff 0px 0px 6px;" class="wixui-rich-text__text"><span style="font-weight:bold;" class="wixui-rich-text__text">2025 Nov 5 · Lecture Performance — NAFA Research Café, Singapore</span></span></span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><br class="wixui-rich-text__text">
        <span class="color_42 wixui-rich-text__text"><span style="text-shadow:#ffffff 0px 0px 6px;" class="wixui-rich-text__text"><span style="font-weight:bold;" class="wixui-rich-text__text">2025 Nov 15 · QUANDARY Performance — MIAO Dance, Singapore</span></span></span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><br class="wixui-rich-text__text">
        <span class="color_42 wixui-rich-text__text"><span style="text-shadow:#ffffff 0px 0px 6px;" class="wixui-rich-text__text"><span style="font-weight:bold;" class="wixui-rich-text__text">2025 Nov 28 – Dec 7 · Inbetween Space Lab with Marie France Forcier &amp; Heidi Strauss,</span></span></span><span class="color_42 wixui-rich-text__text"><span style="text-shadow:#ffffff 0px 0px 6px;" class="wixui-rich-text__text"><span style="font-weight:bold;" class="wixui-rich-text__text"> Singapore</span></span></span></p>
  ...
  '/contact': {
    ...
    render: () => `
      <div class="content-page">
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-size:13px;" class="wixui-rich-text__text">Youtube /&nbsp;<span style="color:#0080FF;" class="wixui-rich-text__text"><span style="text-decoration:underline;" class="wixui-rich-text__text"><a data-auto-recognition="true" href="https://www.youtube.com" target="_blank" class="wixui-rich-text__text">https://www.youtube.com</a>@hejinjangdance</span></span><br class="wixui-rich-text__text">
        Instagram / <a href="https://www.instagram.com/hejinjangdance/" target="_blank" rel="noreferrer noopener" class="wixui-rich-text__text"><span style="color:#0080FF;" class="wixui-rich-text__text"><span style="text-decoration:underline;" class="wixui-rich-text__text">@hejinjangdance</span></span></a></span></p>
  ...
  '/book-publication': {
    ...
    render: () => `
      <div class="content-page">
        ...
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span class="wixui-rich-text__text">​</span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span class="wixui-rich-text__text">​</span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span class="wixui-rich-text__text">​<span class="wixui-rich-text__text">​</span>​</span></p>
  ...
  '/do-not-lean-on-door-2008-09': {
    ...
    render: () => `
      <div class="content-page">
        ...
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-size:14px;" class="wixui-rich-text__text"><span class="wixui-rich-text__text">​</span></span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-size:13px;" class="wixui-rich-text__text"><span style="font-family:wfont_fa2639_bcf5fbef13f34cda81de73a4ee8873cc,wf_bcf5fbef13f34cda81de73a4e,orig_noto_sans_kr_regular;" class="wixui-rich-text__text">Concept/Choreography by He Jin jang</span></span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-size:13px;" class="wixui-rich-text__text"><span style="font-family:wfont_fa2639_bcf5fbef13f34cda81de73a4ee8873cc,wf_bcf5fbef13f34cda81de73a4e,orig_noto_sans_kr_regular;" class="wixui-rich-text__text">Creation/Performance by He Jin Jang, Lyndsey Karr</span></span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-size:13px;" class="wixui-rich-text__text">​</span></p>
  ...
  '/entanglement-residency-2020': {
    ...
    render: () => `
      <div class="content-page">
        ...
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-size:13px;" class="wixui-rich-text__text"><span class="wixui-rich-text__text">​</span>​</span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-size:13px;" class="wixui-rich-text__text"><span class="wixui-rich-text__text">​</span></span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-size:13px;" class="wixui-rich-text__text"><span class="wixui-rich-text__text">​</span></span></p>
        ...
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-size:13px;" class="wixui-rich-text__text"><span class="wixui-rich-text__text">​</span></span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-size:13px;" class="wixui-rich-text__text"><span class="wixui-rich-text__text">​</span></span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-size:13px;" class="wixui-rich-text__text"><span class="wixui-rich-text__text"><span class="wixui-rich-text__text">​</span>​</span></span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-size:13px;" class="wixui-rich-text__text"><span class="wixui-rich-text__text">​</span></span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-size:13px;" class="wixui-rich-text__text"><span class="wixui-rich-text__text">​</span></span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-size:13px;" class="wixui-rich-text__text"><span class="wixui-rich-text__text">​</span></span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-size:13px;" class="wixui-rich-text__text"><span class="wixui-rich-text__text">​</span></span></p>
  ...
  '/exhibition-weekly-weakly-2020': {
    ...
    render: () => `
      <div class="content-page">
        ...
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span class="wixGuard wixui-rich-text__text">​</span>​</p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span class="wixGuard wixui-rich-text__text">​</span></p>
  ...
  '/ghost-shower-2020-21': {
    ...
    render: () => `
      <div class="content-page">
        ...
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span class="wixui-rich-text__text">​</span><span class="wixui-rich-text__text">​​​</span><span class="wixui-rich-text__text">​</span></p>
        ...
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-size:15px;" class="wixui-rich-text__text"><span style="font-family:wfont_fa2639_bcf5fbef13f34cda81de73a4ee8873cc,wf_bcf5fbef13f34cda81de73a4e,orig_noto_sans_kr_regular;" class="wixui-rich-text__text"><span class="wixui-rich-text__text">​</span></span></span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span class="wixui-rich-text__text"><span class="wixui-rich-text__text"><span class="wixui-rich-text__text">​</span>​</span>​</span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span class="wixui-rich-text__text">​</span></p>
  ...
  '/i-bet-you-d-put-that-on-2022': {
    ...
    render: () => `
      <div class="content-page">
        ...
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-style:italic;" class="wixui-rich-text__text"><span style="font-size:15px;" class="wixui-rich-text__text">​​​</span></span></p>
  ...
  '/microhabitat-body-last-words-2020': {
    ...
    render: () => `
      <div class="content-page">
        ...
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span class="wixui-rich-text__text">​</span><span class="wixui-rich-text__text">​</span></p>
  ...
  '/migrant-self-the-speed-of-a-door-2012-16': {
    ...
    render: () => `
      <div class="content-page">
        ...
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-size:13px;" class="wixui-rich-text__text"><span class="wixGuard wixui-rich-text__text">​</span></span></p>
  ...
  '/mirror-neuron-salon-2017': {
    ...
    render: () => `
      <div class="content-page">
        ...
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-size:14px;" class="wixui-rich-text__text">​​</span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><br class="wixui-rich-text__text">
  ...
  '/navigating-uncertain-terrain-with-generosity-2023': {
    ...
    render: () => `
      <div class="content-page">
        ...
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-family:wfont_fa2639_bcf5fbef13f34cda81de73a4ee8873cc,wf_bcf5fbef13f34cda81de73a4e,orig_noto_sans_kr_regular;" class="wixui-rich-text__text"><span class="wixui-rich-text__text">​</span></span></p>
        ...
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span class="wixui-rich-text__text">​</span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span class="wixui-rich-text__text">​</span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span class="wixui-rich-text__text"><span class="wixGuard wixui-rich-text__text">​</span>​</span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span class="wixui-rich-text__text"><span class="wixGuard wixui-rich-text__text">​</span></span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span class="wixui-rich-text__text"><span class="wixGuard wixui-rich-text__text">​</span></span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span class="wixui-rich-text__text"><span class="wixGuard wixui-rich-text__text">​</span></span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span class="wixui-rich-text__text"><span class="wixGuard wixui-rich-text__text">​</span></span></p>
        ...
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-family:wfont_fa2639_bcf5fbef13f34cda81de73a4ee8873cc,wf_bcf5fbef13f34cda81de73a4e,orig_noto_sans_kr_regular;" class="wixui-rich-text__text">​​​​​​​​​​​​​​</span></p>
  ...
  '/slow-carnival-world-2023': {
    ...
    render: () => `
      <div class="content-page">
        ...
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-size:15px;" class="wixui-rich-text__text">​</span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-size:15px;" class="wixui-rich-text__text"><a href="https://www.youtube.com/@hejinjangdance" target="_blank" rel="noreferrer noopener" class="wixui-rich-text__text">​​</a>​​</span></p>
        ...
        &nbsp;</p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-size:15px;" class="wixui-rich-text__text">​</span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span class="wixui-rich-text__text">​</span><span style="font-size:15px;" class="wixui-rich-text__text"><span class="wixui-rich-text__text">​</span>​</span></p>
        ...
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span class="wixui-rich-text__text">​</span><span style="font-size:15px;" class="wixui-rich-text__text">​</span></p>
        ...
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-size:15px;" class="wixui-rich-text__text">4-6pm 흐르는 액션</span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-size:15px;" class="wixui-rich-text__text">6-7pm 공연 (COMMON RITUAL) </span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-size:15px;" class="wixui-rich-text__text"><span class="wixui-rich-text__text"><span class="wixui-rich-text__text">​</span>​</span>​</span></p>
  ...
  '/the-flowing-2021-23': {
    ...
    render: () => `
      <div class="content-page">
        ...
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span class="wixui-rich-text__text">​</span><span style="font-style:italic;" class="wixui-rich-text__text"><span class="wixui-rich-text__text">​</span></span></p>
        ...
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-style:italic;" class="wixui-rich-text__text">​</span></p>
        ...
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span style="font-style:italic;" class="wixui-rich-text__text"><span class="wixui-rich-text__text">​</span></span></p>
  ...
  '/you-cannot-disinvite-x-being-2021': {
    ...
    render: () => `
      <div class="content-page">
        ...
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;"><span class="color_38 wixui-rich-text__text"><span style="text-decoration:underline;" class="wixui-rich-text__text"><span class="wixui-rich-text__text">​</span></span></span></p>
        <p class="font_8 wixui-rich-text__text" style="font-size:15px; text-align:justify; margin-bottom: 24px;">Concept and Artistic Direction by He Jin Jang</p>
